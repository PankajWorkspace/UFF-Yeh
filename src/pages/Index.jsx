...
const Index = () => {
    return (
        <>
            <div class="main">
                <h2 class="search-main">Video Streaming OTT Platform</h2>
                <p>One OTT solution for all your needs providing a world-class video experience.</p>
            </div>

            <div id="benefits">
                <header class="benefits-head">
                    <h2>Highlights Of Our OTT Services</h2>
                    <p>OTT Fast provides all media management tools in one place. Upload, store, edit and schedule the data according to your requirements.</p>
                    <div class="inspirations-wrapper">
                        <div class="inspiration1 inspirations">
                            <h3>OTT Platform</h3>
                            <br />
                            <h4>OTT Platform Deliver top-notch video quality for your VoD and live content to multiple devices seamlessly, effortlessly.</h4>
                            <br />
                        </div>
                        <div class="inspiration1 inspirations">
                            <h3>Cost Efficient</h3>
                            <br />
                            <h4>Leverage our affordable pricing plans to monetize your video content and generate greater ROI.</h4>
                            <br />
                        </div>
                        <div class="inspiration1 inspirations">
                            <h3>Video Hosting</h3>
                            <br />
                            <h4>With our management tools, you can upload, store, edit, schedule, and analyze your data at your convenience.</h4>
                            <br />
                        </div>
                    </div>
                    <div class="inspirations-wrapper">
                        <div class="inspiration1 inspirations">
                            <h3>Media Player</h3>
                            <br />
                            <h4>Deliver your content across all devices including mobiles, tablets, desktops, smart TVs, etc. seamlessly.</h4>
                            <br />
                        </div>
                        <div class="inspiration1 inspirations">
                            <h3>Video Transcoding</h3>
                            <br />
                            <h4>With the use of this technology, we create copies of video files in different available sizes making delivery quick.</h4>
                            <br />
                        </div>
                        <div class="inspiration1 inspirations">
                            <h3>Video Conferencing</h3>
                            <br />
                            <h4>Experience flawless connectivity over personal or business chats without lag and with minimal data required</h4>
                            <br />
                        </div>
                    </div>
                </header>
            ...
            {/* <div id="inspiration">
        <h2>Get Inspiration with Tripoto's Exclusive Online Workshops</h2>
        <div class = "inspirations-wrapper">
            <div class="inspiration1 inspirations">
                <img src="./Assets/inspirations/inpspirations1.png"/>
                <h3>PACKAGE</h3>
                <br/>
                <h4>How To Give Up City Life and Settle in The Mountains|Anu</h4>
                <br/>
                <div class="inspirations-flex">
                    <h4>Rs 1,000/person</h4>
                    <button>Book Now</button>
                </div>  
            </div>
            <div class="inspirations2 inspirations">
                <img src="./Assets/inspirations/inspirations2.png"/>
                <h3>PACKAGE</h3>
                <br/>
                <h4>Ways To Travel While Managing Your Own Expenses As A Student| Kalash Rajvansh</h4>
                <br/>
                <div class="inspirations-flex">
                    <h4>Rs 1,000/person</h4>
                    <button>Book Now</button>
            ...
            <div class="inspirations3 inspirations">
                <img src="./Assets/inspirations/inspirations3.png"/>
                <h3>PACKAGE</h3>
                <br/>
                <h4>How To Travel In Exchange For Work|Raghu Raahi</h4>
                <br/>
                <div class="inspirations-flex">
                    <h4>Rs 1,000/person</h4>
                    <button>Book Now</button>
            ...
            <div id="packages">
                ...
                <div class="product-cards">
                    <div class="card1 card">
                        <h3>PACKAGE</h3>
                        <br />
                        <h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente, vel!</h4>
                        <br />
                    </div>
                    ...
                    <div class="card2 card">
                        <h3>PACKAGE</h3>
                        <br />
                        <h4>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsam, nulla?</h4>
                        <br />
                    </div>
                    ...
                    <div class="card3 card">
                        <h3>PACKAGE</h3>
                        <br />
                        <h4>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, corporis!</h4>
                        <br />
                    </div>
                    ...
                    <div class="card4 card">
                        <h3>PACKAGE</h3>
                        <br />
                        <h4>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, architecto.</h4>
                        <br />
                    </div>
                </div>
            </div>
            ...
            <div class="inspirations-wrapper">
                <div class="inspiration1 inspirations">
                    ...
                    <br />
                    <h4>Launch a top-tier streaming service with more than 150 features and many revenue sources.</h4>
                    <br />
                </div>
                <div class="inspiration1 inspirations">
            ...
            <div id="contact">
                <div class="form-wrapper">
                    <header class="form-head">
                        ...
                        <p>We won’t just help you launch your OTT service, we can also advise and support you as your ott streaming service continues to expand into new markets. Leverage our years of experience to build a successful OTT business.</p>
                    </header>
                    <div class="inspirations-wrapper">
                        <div class="rap">
                            <h3>OTT Platform</h3>
